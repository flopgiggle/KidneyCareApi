...
namespace KidneyCareApi
{
    ...
    public class UploadHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            //string folder =HttpContext.Current.Server.MapPath(@context.Request["folder"]) + "\\";
            //string folder = context.Request["folder"];
            //获取文件的保存路径
            string uploadPath =HttpContext.Current.Server.MapPath(Util.GetConfigByName("UploadPath") + "\\");
            //string uploadPath = HttpContext.Current.Server.MapPath(Util.GetConfigByName("upload"));
